...
export default function LunaLlenaDetail({ onNavigate }: LunaLlenaDetailProps) {
  ...
  const { media: galleryMedia, isLoaded: mediaLoaded } = useAfterMovieMedia("luna-llena")
    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <section className="relative min-h-[70vh] flex flex-col justify-end pb-8">
        ...
        <div
          ...
          style={{
            backgroundImage: `url('https://f005.backblazeb2.com/file/b21of1firm/background/LLback.png')`,
          }}
        />
        ...
        <div className="relative z-10 px-4 md:px-8 text-center">
          ...
          <div className="space-y-3 text-left max-w-xs mx-auto">
            <div className="flex items-center gap-3">
              ...
              <div>
                <span className="text-amber-500 text-xs tracking-wider">{event?.dateLabel || "FECHA PRÓXIMAMENTE"}</span>
                <p className="text-white/60 text-xs">{event?.dateSubtitle || "PRONTO SERÁ ANUNCIADA"}</p>
              </div>
            </div>
            <div className="flex items-center gap-3">
          ...
          <div className="relative z-10 flex items-center justify-between">
            <div>
              ...
              <button 
                ...
                className="flex items-center gap-2 mt-3 text-white/80 hover:text-amber-500 transition-colors"
              >
